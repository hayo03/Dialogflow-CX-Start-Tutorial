...
<p align="center">
  <img src="images/Weather-forecast-flow.png"> <img src="images/weather-forecast-conversation.png">
</p>
...
We need to first create a webhook and add it to the fulfillment in "Get current weather" page:
1. Create webhook 
...
2. Add a webhook to a fulfillment
   - Click on "Get current weather" page
